        ...
        <div className='container border-top pt-5 mt-5'>
         <div className='row mb-4'>
             <div className='col pe-5 '>
                <img src="media/images/logo.svg" alt="logo" style={{width:"60%" ,}}></img>
                ...
                <div className='d-flex gap-3 pt-5 fs-5'>
                <i class="fa-brands fa-youtube"></i>
                <i class="fa-brands fa-whatsapp"></i>
                <i class="fa-brands fa-telegram"></i>
                </div>
                <div className='d-flex gap-2 pt-4'>
                    <img src="media/images/googleplayBadge.svg" alt="logo" style={{width:"60%" ,}}></img>
                <img src="media/images/appstorebadge.svg" alt="logo" style={{width:"60%" ,}}></img>
                </div>
             </div>
             <div className='col'><p className='foot-head'>Account</p>
             ...
             <div className='col'><p className='foot-head'>Support</p>
             ...
             <div className='col'><p className='foot-head'>Company</p>
             <a href="">About</a><br/>
             ...
             <div className='col'><p className='foot-head'>Quick Links</p>
         ...
         <p className='foot-para'>Zerodha Broking Ltd.: Member of NSE, BSE, MCX & MSEI – SEBI Registration no.: INZ000031633 CDSL/NSDL: Depository services through Zerodha Broking Ltd. – SEBI Registration no.: IN-DP-431-2019 Registered Address: Zerodha Broking Ltd., #153/154, 4th Cross, Dollars Colony, Opp. Clarence Public School, J.P Nagar 4th Phase, Bengaluru - 560078, Karnataka, India. For any complaints pertaining to securities broking please write to <span>complaints@zerodha.com</span>, for DP related to dp@zerodha.com. Please ensure you carefully read the Risk Disclosure Document as prescribed by SEBI | ICF
